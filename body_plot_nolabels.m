...
print(gcf, 'figs/supplement/media_nolabels_sensations_body.tif', '-dtiffn', '-r400') % journal format
print(gcf, 'figs/supplement/media_nolabels_sensations_body_.tif', '-dtiff', '-r400') % journal format